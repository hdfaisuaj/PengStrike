"""
commix 工具 (tools/modules/vuln_scan/commix.py)
"""
...
class CommixTool(BaseTool):
    ...
    metadata = ToolMetadata(
        name="commix",
        description="Commix 命令注入检测和利用工具",
        ...
        parameters=[
            ...
            ToolParameter(name="technique", type="string", description="technique 参数", required=True),
            ToolParameter(name="level", type="string", description="level 参数", required=True),
            ToolParameter(name="batch", type="string", description="batch 参数", required=True),
        ],
